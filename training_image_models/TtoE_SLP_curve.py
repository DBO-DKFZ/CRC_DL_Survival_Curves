...
The SlideModel receives features of all tiles of a histological whole slide image and predicts the monthly hazards of the first 60 months after diagnosis which is transformed to a five-year survival curve (piecewise constant hazard assumption)
